...
# url='https://api.thegraph.com/subgraphs/name/messari/dydx-governance'
...
first = 1000
skip = 0
last_id = 1706832000 # april 1
last_timestamp = None

timestamp_lte=1706832999

# timestamp_lte = 1706918999 # may 1
...
print("All swap data has been retrieved and saved in v2.json!")